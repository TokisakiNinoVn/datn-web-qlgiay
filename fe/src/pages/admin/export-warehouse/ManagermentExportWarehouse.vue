<template>
  <div class="container">
    ...
    <div class="main-content">
      <!-- Header -->
      <div class="header">
        <h1 class="title">Quản lý đơn xuất kho</h1>
        <div class="stats">
          <span>Tổng: {{ filteredEnterWarehouses.length }} đơn xuất kho</span>
        </div>
      </div>
        ...
        <div class="filters">
          ...
          <div class="filter-actions">
            ...
            <button @click="showAddForm" class="add-btn">
              <router-link :to="`/exportwarehouse-create`">
                <i class="fas fa-plus mr-2" style="margin-right: 8px;"></i> Thêm đơn xuất kho
              </router-link>
            </button>
            <div>
...
const fetchAllEnterWarehouse = async () => {
  ...
  try {
    const response = await getAllExportWarehouseApi();
