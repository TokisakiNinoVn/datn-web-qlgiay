  ...
  <div v-if="visible" class="modal-overlay" @click.self="closeDetail">
    <div class="modal-content">
      <div class="modal-header">
        <h2>Chi tiết Nhà cung cấp: {{ supplier.name }}</h2>
        ...
        <table class="detail-table">
          <tbody>
            <!-- <tr>
              ...
              <td class="value">{{ supplier.id }}</td>
            </tr> -->
            <tr>
              <td class="label">Tên nhà cung cấp</td>
            ...
            <tr>
              ...
              <td class="value">{{ formatDate(supplier.createdAt) }}</td>
            </tr>
            <tr>
              <td class="label">Cập nhật cuối</td>
              <td class="value">{{ formatDate(supplier.updateAt) }}</td>
            </tr>
          </tbody>
        </table>
      </div>
